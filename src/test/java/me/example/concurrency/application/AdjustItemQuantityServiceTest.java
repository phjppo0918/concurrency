...
import me.example.concurrency.application.optimistic.OptimisticTestConfig;
import me.example.concurrency.application.pessimistic.PessimisticTestConfig;
...
class AdjustItemQuantityServiceTest {
    @Autowired
    ItemRepository itemRepository;
    @Autowired
    AdjustItemQuantityService adjustItemQuantityService;
    ...
    void decrease() {
        ...
        adjustItemQuantityService.decrease(new AdjustQuantityCommand(id, 50));
    ...
    void decreaseConcurrency() {
        ...
        ConcurrentExecutor.execute(
                () ->  adjustItemQuantityService.decrease(new AdjustQuantityCommand(id, 10)),
                100
        );
